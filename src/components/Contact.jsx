  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setLoading(false);
          alert("Teşekkür ederim. En kısa zamanda dönüş yapacağım.");
        ...
        (error) => {
          ...
          alert("Bir şeyler yanlış gitti. Tekrar dene!");
        }
      );
  };
      ...
      >
        ...
        >
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-4'>İsim</span>
            <input
              type='text'
              name='name'
              value={form.name}
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder='Ne demek istersiniz?'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
